...
*--resolution*=RESOLUTION::
  ...
  _line_|_word_|_char_ (default is _word_)

*--line*::
  set resolution to _line_

*--word*::
  set resolution to _word_

*--char*::
  set resolution to _char_

*--encoding*=ENCODING::
  specify character encoding
  _ASCII_|_EUC-JP_|_Shift_JIS_|_CP932_|_UTF-8_|_auto_
  (default is _auto_. try _ASCII_ for single byte encodings such as ISO-8859-X)
...
*--eol*=EOL::
  ...
  _CR_|_LF_|_CRLF_|_auto_ (default is _auto_)
...
*--format*=FORMAT::
  ...
  _tty_|_manued_|_html_|_wdiff_|_stat_|_user_
  (default is _html_)
...
*--stat*::
  same as *--format*=_stat_ (not supported yet)
